...
const Footer = () => {
    return (
        <div>
            <footer className="p-4 sm:p-6 bg-gray-800 mt-28">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <a href="https://twitter.com" className="flex items-center">
                            <img src="https://cdn-icons-png.flaticon.com/512/733/733579.png?w=360" className="mr-3 h-10" alt="GitHub Logo" />
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://twitter.com" className="hover:underline">
                        Twitter™</a>.{" "} All Rights Reserved.
                    </span>
